...
public class UpdateStatement<T> extends QueryableStatement {
    ...
    public UpdateStatement(final @NonNull Context context,
    ...
    public PreparedUpdateStatement prepareStatement() {
        return new PreparedUpdateStatement();
    }

    public class PreparedUpdateStatement implements PreparedStatement {
