...
public class GetSingleStatement<T> extends QueryableStatement {
    ...
    GetSingleStatement(final @NonNull Context context,
    ...
    public PreparedStatement prepareStatement() {
        return new PreparedGetSingleStatement();
    }

    public class PreparedGetSingleStatement implements PreparedStatement {

        PreparedGetSingleStatement() {
