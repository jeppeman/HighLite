...
public class DeleteStatement<T> extends QueryableStatement {
    ...
    DeleteStatement(final @NonNull Context context,
    ...
    @Override
    public PreparedDeleteStatement prepareStatement() {
        return new PreparedDeleteStatement();
    }

    public class PreparedDeleteStatement implements PreparedStatement {
